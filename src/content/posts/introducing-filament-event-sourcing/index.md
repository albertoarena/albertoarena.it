...
This plugin is part of a small ecosystem I've been building around Spatie's package: see also the [Spatie event sourcing generator](/posts/domain-using-spatie-event-sourcing/) for scaffolding new domains and the [Claude Code skill](/posts/ai-laravel-event-sourcing/) for designing them conversationally.
